...
<html lang="en">
    <head>
        ...
        <%session.setAttribute("paginaActual", "bajaUsuarios");%>
                ...
                <table class="bordered highlight responsive-table" style="margin-bottom: 350px" >
                    ...
                    %>  
                        <tr>
                            ...
                            <td> 
                            <td> 
                                <form action="/usuarioEliminarUno.do">
                                    <button type="submit" name="btn" value="<%=usuario.getEmail()%>" class="btn-floating btn-large waves-effect waves-light red">
