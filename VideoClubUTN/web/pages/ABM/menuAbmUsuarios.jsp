<%-- 
    Document   : administrarUsuariosMenu
    Created on : Sep 18, 2016, 3:35:18 PM
    Author     : MiLaptop
--%>
...
<html lang="en">
    <head>
        ...
        <%session.setAttribute("paginaActual", "menuAbmUsuarios");%>
        ...
        <% 
            ...
            {%>
                ...
                <div class="collection" style="margin-bottom: 400px">
                    <a href="usuarios/altaUsuario.jsp" class="collection-item">Alta Usuario <i class="material-icons secondary-content">send</i></a>
                    <a href="/usuarioBaja.do" class="collection-item">Baja Usuarios <i class="material-icons secondary-content">send</i></a>
                    <a href="/usuarioModificacion.do" class="collection-item">Modificar Usuario <i class="material-icons secondary-content">send</i></a>
                </div>
