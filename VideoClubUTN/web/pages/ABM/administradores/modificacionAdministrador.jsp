<%-- 
    Document   : modificacionAdministrador
...
<html lang="en">
    <head>
        ...
        <%session.setAttribute("paginaActual", "modificacionAdministrador");%>
...
<body onLoad="informar()">
    ...
    <div class="container">
        <% 
            ...
            {%>
            <h2>Modificacion de Administradores</h2>
            <table class="bordered highlight responsive-table" style="margin-bottom: 350px;">
                ...
                %> 
                    ...
                    <tr>
                        ...
                        <td> 
                            <form action="/adminModificarUno.do">
            ...
            <a href="/pages/ABM/menuAbmAdministradores.jsp" class="waves-effect waves-light btn-large" style="margin-bottom: 110px"><i class="material-icons right">fast_rewind</i>Volver</a>
            <%} 
                else {%> 
