...
<html lang="en">
    <head>
        ...
        <%session.setAttribute("paginaActual", "altaAdministrador");%>
    </head>
    ...
    <div class="container">
        <% 
           ...
           if(tipo.equals("admin"))
            ...
            <div class="row">
                <form class="col s12" action="/adminAlta.do">
                  <div class="card blue-grey darken-1">
                      <div class="card-content white-text">
                        <span class="card-title">Alta Administrador</span>
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <input name="pass1" id="password" type="password" class="validate">
                              <label for="pass1">Contraseña temporal</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input name="pass2" id="password" type="password" class="validate">
