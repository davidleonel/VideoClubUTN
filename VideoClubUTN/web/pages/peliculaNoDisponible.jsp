<%-- 
    Document   : peliculaNoDisponible
    Created on : Sep 29, 2016, 8:55:38 PM
    Author     : MiLaptop
--%>
...
<html lang="en">
  <head>
        ...
        <%session.setAttribute("paginaActual", "peliculaNoDisponible");%>
  </head>
  <body>
            ...
            <div class="col s6 offset-s3" style="margin-top: 100px; margin-bottom: 100px">
                <div class="card center-align " style="border: 2px black solid">
                    ...
                    <div class="card-content">
                        <span class="card-title black-text">Pelicula agotada en este momento!</span>
                    </div>
                    <div class="card-action">
                        <p>Lo sentimos, la pelicula que usted busca esta agotada momentaneamente. Por favor vuelva a intentarlo mas adelante o busque otra pelicula!</p>
                    </div>
                  </div>
                      ...
                      <span class="card-title">Buscar Pelicula por Titulo</span>
                        <div class="row">
                            <form action="/buscarPelicula.do">
                                ...
                                <button class="btn waves-effect waves-light right" type="submit" name="action" style="margin-top: 15px">Buscar
                      ...
                      <span class="card-title">Buscar Peliculas por Genero</span>
                        ...
                        <div class="row">
                            <form action="/buscarPeliculas.do">
                                ...
                                <button class="btn waves-effect waves-light right" type="submit" name="action">Buscar
                                    <i class="material-icons right">send</i>
                                </button>
                            </form>
                        </div>         
