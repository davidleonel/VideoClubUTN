<%-- 
    Document   : mostrarEstrenosPeliculas
    Created on : Nov 10, 2016, 6:19:52 PM
    Author     : MiLaptop
--%>
...
<html lang="en">
  <head>
        ...
        <%session.setAttribute("paginaActual", "peliculamostrarEstrenos");%>
    ...
    <div class="container-fluid">
        ...
        <div class="card blue-grey darken-1">
            <div class="card-content white-text" style="padding-top: 10px; padding-bottom: 10px">
                <H2 style="margin: 0;">Estrenos:</H2>
            </div>                
        </div>
        <div class="row">
            <div class="col s10 offset-s1">
            <% 
            ArrayList<Pelicula> listaPeliculas = (ArrayList)request.getAttribute("listaEstrenos");
