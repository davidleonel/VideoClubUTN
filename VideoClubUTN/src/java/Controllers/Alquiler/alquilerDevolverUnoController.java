...
public class alquilerDevolverUnoController extends HttpServlet {
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BaseDeDatos.Alquileres.AlquileresFunc funciones = new BaseDeDatos.Alquileres.AlquileresFunc();
            ...
            try{
                ...
                request.setAttribute("AlquilerADev", alquiler);
                session.setAttribute("PeliculaADev", alquiler.getNombrePelicula());
                RequestDispatcher rd = request.getRequestDispatcher("/pages/devolverPeliculaSeleccionada.jsp");
