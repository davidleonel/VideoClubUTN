...
public class alquilerDevolverController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BaseDeDatos.Alquileres.AlquileresFunc funciones = new BaseDeDatos.Alquileres.AlquileresFunc();
            ...
            try{
                ...
                ArrayList<Alquiler> listaAlquileres = funciones.getAllgetAllPendientes(email);

                request.setAttribute("listaAlquileres", listaAlquileres);
                RequestDispatcher rd = request.getRequestDispatcher("/pages/devolverPelicula.jsp");
