...
public class adminAltaController extends HttpServlet {
                  ...
                  if(validar.esIgual(pass1, pass2)&& !validar.estaVacio(pass1) && !validar.estaVacio(pass2))
                    ...
                    if(funciones.buscar(email1))
                        { 
                            ...
                            response.sendRedirect("altaAdministrador.jsp");
                        }else{
                        ...
                        session.setAttribute("mensajeExito", "Administrador añadido correctamente.");
                        response.sendRedirect("/pages/ABM/menuAbmAdministradores.jsp");
                        }
                      }
                } 
        }
