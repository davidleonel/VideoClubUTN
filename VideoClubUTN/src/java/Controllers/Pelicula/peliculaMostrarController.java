...
public class peliculaMostrarController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BaseDeDatos.Peliculas.PeliculasFunc funciones = new BaseDeDatos.Peliculas.PeliculasFunc();
            ...
            try{
                ArrayList<Pelicula> estrenos = funciones.getAll();
                request.setAttribute("estrenos", estrenos);
                RequestDispatcher rd = request.getRequestDispatcher("pages/generales/indexContent.jsp");
