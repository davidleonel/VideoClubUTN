<%-- 
    Document   : usuarioRequiereLogeo
    Created on : Sep 29, 2016, 9:11:58 PM
    Author     : MiLaptop
--%>
...
<html lang="en">
  <head>
        ...
        <%session.setAttribute("paginaActual", "usuarioRequiereLogeo");%>
  </head>
  <body>
                ...
                <div class="col s8 offset-s2"  style="margin-top: 20px;">
                    <div class="card center-align " style="border: 2px black solid">
                        ...
                        <div class="card-action">
                            <p>Lo sentimos, usted debe logearse antes de poder continuar. Por favor ingrese usando su contraseña.</p>
